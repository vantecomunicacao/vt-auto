...
export function VehicleSidebarVTClass({
  price, waLink, storeName, storeSlug, storeCity, storeState, storePhone,
    ...
    <FavoritesProvider storeSlug={storeSlug}>
      <div className="space-y-2">
        ...
        <button
          ...
          className="w-full py-3 text-white text-sm font-bold uppercase tracking-wide transition-opacity hover:opacity-90"
