// ─── Shared SVG icons for storefront ────────────────────────────────────────
...
export function EmptySearchIcon({ className = 'w-14 h-14' }: IconProps) {
  return (
...
export function LocationIcon({ className = 'w-3.5 h-3.5' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
