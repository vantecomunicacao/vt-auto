...
import { fuelLabel, transmissionLabel, formatPrice, formatMileage } from '../storefront-helpers'
...
export function CardPremium({ vehicle, sf, primaryColor, secondaryColor, whatsappPhone, index }: CardProps) {
